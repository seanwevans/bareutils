...
section .bss
    mode:       resq 1    ; Store file mode
    filename:   resb 256  ; Store filename
...
_start:
    pop rcx             ; Get argc
    cmp rcx, 3          ; Check if we have exactly 3 arguments (program name + mode + filename)
    ...
    test rax, rax
    js chmod_error      ; Jump if sign flag set (negative return value = error)

...
section .bss
    oldpath:    resb 4096       ; Buffer for the source file path
    newpath:    resb 4096       ; Buffer for the destination file path
...
perform_link:
    ...
    test rax, rax
    js print_error              ; If negative, there was an error

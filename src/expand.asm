...
section .data
    tab_size    equ 8           ; Default tab size (8 spaces)
...
process_input:
    ...
    mov rsi, in_buffer  ; rsi = input buffer pointer
    mov rdi, out_buffer ; rdi = output buffer pointer
    mov r8, 0           ; r8 = input index
    mov r9, 0           ; r9 = output index

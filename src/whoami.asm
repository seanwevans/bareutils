...
.read_loop:
    ...
    mov r14, file_buffer  ; r14 = Pointer to current position in buffer
    mov r15, rax          ; r15 = Bytes remaining in the current buffer chunk
...
.found_colon3:
    ...
    ret                   ; Return with rax=ptr, r8=len
